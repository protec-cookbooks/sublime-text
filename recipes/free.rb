...
remote_file "/tmp/Sublime_Text_2.0.1_x64.tar.bz2" do
...
script "sublime-text-extract" do
  interpreter "bash"
  code <<-EOH
    tar xfj /tmp/Sublime_Text_2.0.1_x64.tar.bz2 -C /opt/sublime-text
  EOH
end

link "/usr/local/bin/sublime-text" do
  to "/opt/sublime-text/Sublime Text 2/sublime_text"
  link_type :symbolic
end
